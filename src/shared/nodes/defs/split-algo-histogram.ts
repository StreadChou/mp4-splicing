...
export const SPLIT_ALGO_HISTOGRAM_NODE: NodeDefinition = {
  type: NodeType.SPLIT_ALGO_HISTOGRAM,
  name: "直方图拆解算法",
  summary: "输出直方图拆解算法配置。",
  palette: true,
  ports: [
  ...
  defaults: {
    algorithm: SplitAlgorithmKind.HISTOGRAM,
    threshold: 0.88,
    minDuration: 2,
  },
  runtime: {
    executor: "split_algo_histogram",
  },
};
