...
export const SPLIT_ALGO_FRAME_DIFF_NODE: NodeDefinition = {
  type: NodeType.SPLIT_ALGO_FRAME_DIFF,
  name: "帧差异拆解算法",
  summary: "输出帧差异拆解算法配置。",
  palette: true,
  ports: [
  ...
  defaults: {
    algorithm: SplitAlgorithmKind.FRAME_DIFF,
    threshold: 0.15,
    minDuration: 2,
  },
  runtime: {
    executor: "split_algo_frame_diff",
  },
};
